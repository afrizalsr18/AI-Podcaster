      ...
      <Form {...form}>
        ...
        >
          <div className="flex flex-col gap-[30px] border-black-5 pb-10 ">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value) => setVoiceType(value)}>
                ...
                <SelectContent className="text-16 border-none bg-black-1 font-bold text-white-1 focus-visible:ring-offset-orange-1 focus-visible:!text-black">
          ...
          <div className="flex flex-col pt-10">
            ...
            />
            <div className="mt-10 w-full text-black-1">
              <Button
                type="submit"
                className="w-full bg-orange-1 text-black-1 text-16 font-extrabold py-4 transition-all duration-500 hover:bg-black-1"
              >
                {isSubmitting ? (
                  <>
                    Creating
